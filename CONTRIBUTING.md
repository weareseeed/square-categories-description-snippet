# Contributing to square-categories-description-snippet

First and foremost, thank you! We appreciate that you want to contribute to square-categories-description-snippet, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for square-categories-description-snippet**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for square-categories-description-snippet:

- star the [project](https://github.com/weareseeed/square-categories-description-snippet)
- tweet your support for square-categories-description-snippet
...
- **version**: (required) please note the version of square-categories-description-snippet are you using
- **error messages**: (required) please paste any error messages into the issue, or a [gist](https://gist.github.com/)
- **extensions, plugins, helpers, etc** (if applicable): please list any extensions you're using

### Closing issues

The original poster or the maintainers of square-categories-description-snippet may close an issue at any time. Typically, but not exclusively, issues are closed when:
